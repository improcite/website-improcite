  ...
  <div class="col-md-8 my-3">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <a href="{$infos.lien_mobilizon}" class="btn btn-outline-primary my-2" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-link me-2"></i>Voir l'événement sur Mobilizon</a>
        {/if}
      </div>
