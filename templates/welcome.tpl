<div class="card text-white mb-3">
  ...
  <div class="card-img-overlay">
    <h2 class="card-title text-white">Bienvenue sur le site d'Improcité</h2>
    <p class="card-text fs-5 text-white">Troupe amatrice d'improvisation théâtrale depuis 2003&nbsp;!</p>
  </div>
</div>
