...
{for $membre_id = 0 to count($membres)-1}
  <div class="col-md-3 mb-4">
    <div class="card shadow">
      <img src="{photo_membre id_membre={$membres.$membre_id.id} id_saison={$id_saison}}" class="card-img-top" alt="Photo de {$membres.$membre_id.prenom}" title="{$membres.$membre_id.prenom}" />
      <div class="card-body">
